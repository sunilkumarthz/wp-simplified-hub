  ...
  return (
    <>
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute bottom-10 right-10 w-96 h-96 bg-wp-teal-dark/10 rounded-full blur-3xl floating-animation"
            ...
            <div className="space-y-8 animate-slide-in-left">
              ...
              <div className="bg-slate-700/30 p-6 rounded-xl border border-slate-600/30">
                ...
                <p className="text-slate-300 leading-relaxed mb-4">
                  Welcome to{' '}
                  <strong className="text-wp-teal">
                    WPSimplified: The WordPress Creator Podcast
                  </strong>
                  —your weekly guide to mastering WordPress without the
                  overwhelm. Hosted by Sunil, this series breaks down complex
                  tools, features, and workflows into easy, actionable steps.
                </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-start space-x-3 p-4 bg-slate-700/30 rounded-xl border border-slate-600/30">
                  ...
                  <span className="text-slate-300">
                    Share your WordPress journey and expertise
                  </span>
                </div>
                <div className="flex items-start space-x-3 p-4 bg-slate-700/30 rounded-xl border border-slate-600/30">
                  <div className="w-3 h-3 bg-wp-teal rounded-full mt-2 flex-shrink-0"></div>
                  <span className="text-slate-300">
                    Reach a growing audience of WordPress enthusiasts
                  </span>
                </div>
                <div className="flex items-start space-x-3 p-4 bg-slate-700/30 rounded-xl border border-slate-600/30">
                  <div className="w-3 h-3 bg-wp-teal rounded-full mt-2 flex-shrink-0"></div>
                  <span className="text-slate-300">
                    Network with other WordPress professionals
                  </span>
                </div>
                <div className="flex items-start space-x-3 p-4 bg-slate-700/30 rounded-xl border border-slate-600/30">
                  <div className="w-3 h-3 bg-wp-teal rounded-full mt-2 flex-shrink-0"></div>
              ...
              <div className="pt-6">
                <h3 className="text-3xl font-baloo font-bold text-white mb-6">
                  Who Should Apply?
                </h3>
                <p className="text-slate-300 leading-relaxed mb-8 text-lg">
                  WordPress developers, designers, agency owners, plugin
                  creators, and anyone with valuable insights to share with the
                  WordPress community.
                </p>
              ...
              <Card className="bg-slate-800/80 border-slate-600/50">
                <CardContent className="p-10">
                  <div className="text-center space-y-8">
                    ...
                    <div>
                      <h3 className="text-3xl font-baloo font-bold text-white mb-3">
                        The WordPress Creator Podcast
                      </h3>
                      <p className="text-wp-teal font-semibold text-lg">
                        WordPress Stories & Insights
                      </p>
                    </div>
                    ...
                    {!isLoading && latestPodcast && (
                      <div className="bg-slate-700/50 rounded-xl p-6 border border-slate-600/30">
                        <div className="flex items-center justify-between mb-4">
                          <h4 className="font-baloo font-semibold text-white text-lg">
                            Latest Episode
                          </h4>
                    ...
                    <div className="grid grid-cols-1 gap-6 pt-6">
                      <div className="text-center p-4 bg-slate-700/30 rounded-xl border border-slate-600/30">
                        <div className="text-3xl font-baloo font-bold text-wp-teal mb-2">
                          {totalEpisodes}+
                        </div>
