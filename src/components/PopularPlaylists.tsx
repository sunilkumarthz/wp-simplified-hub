  ...
  return (
    <section className="py-20 bg-slate-900 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full">
        ...
        <div className="absolute bottom-20 left-10 w-64 h-64 bg-[#037F8C]/10 rounded-full blur-3xl floating-animation" style={{ animationDelay: '2s' }}></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        {isLoading && (
          <div className="text-center py-20">
            ...
            <div className="text-white font-roboto text-lg">Loading amazing playlists...</div>
          </div>
        )}

        {error && (
          <div className="text-center py-20">
            <div className="text-red-400 font-roboto text-lg">Unable to load playlists. Please try again later.</div>
          </div>
        )}
                  ...
                  <CardContent className="p-0">
                    <div className="flex flex-col md:flex-row h-full">
                      <div className="relative md:w-2/5 group/image">
                        ...
                        {playlist.difficulty && (
                          <div className={`absolute top-4 left-4 ${getDifficultyColor(playlist.difficulty)} text-white text-sm px-3 py-1 rounded-full font-semibold shadow-lg`}>
                            {playlist.difficulty}
                          </div>
                        )}
