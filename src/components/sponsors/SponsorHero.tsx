...
const SponsorHero = () => {
  return (
    <div className="relative py-24 overflow-hidden bg-gradient-to-br from-background via-muted/20 to-background">
      {/* Animated Background Elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 left-1/4 w-64 h-64 bg-primary/10 rounded-full blur-3xl animate-pulse"></div>
        <div
          className="absolute bottom-20 right-1/4 w-80 h-80 bg-secondary/10 rounded-full blur-3xl animate-pulse"
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-5xl mx-auto">
          ...
          <h1 className="text-5xl md:text-6xl font-baloo font-bold text-white mb-6">
            Partner with <span className="text-gradient">WPSimplified</span>
          </h1>
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-12 leading-relaxed max-w-4xl mx-auto animate-fade-in">
            ...
            education platform. Reach{' '}
            <span className="text-primary font-semibold">100,000+</span>{' '}
            passionate developers and business owners worldwide.
          </p>
