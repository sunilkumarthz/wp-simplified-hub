...
const FeaturedVideos = () => {
  ...
  return (
    <section className="py-20 bg-slate-800/50 relative overflow-hidden">
      ...
      <div
        className="absolute bottom-10 right-10 w-72 h-72 bg-wp-blue/5 rounded-full blur-3xl floating-animation"
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-xl text-slate-300 max-w-2xl mx-auto font-roboto">
            Discover our most popular WordPress tutorials and step-by-step
            guides
          </p>
        </div>
        ...
        {error && (
          <div className="text-center py-12">
            <div className="text-red-400 font-roboto">
